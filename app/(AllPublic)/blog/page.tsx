      ...
      <header className="sticky top-0 z-40 w-full border-b border-gray-800 bg-black/95 backdrop-blur">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link href="/blog" className="text-sm font-medium text-silver transition-colors">
              Blog
            </Link>
        ...
        <section className="py-12 md:py-20 bg-gradient-to-b from-black to-gray-900">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center space-y-4 mb-12">
              <Badge className="mb-2 bg-gray-800 text-silver hover:bg-gray-800/90">Blog</Badge>
              <h1 className="text-3xl md:text-5xl font-bold tracking-tight">Insights & Articles</h1>
            ...
            <div className="mt-16">
              ...
              <div className="flex flex-wrap gap-3">
                <Badge className="bg-gray-800 text-silver hover:bg-gray-700 px-4 py-2 text-sm">All</Badge>
                <Badge className="bg-gray-900 text-silver hover:bg-gray-800 px-4 py-2 text-sm">Web Development</Badge>
                <Badge className="bg-gray-900 text-silver hover:bg-gray-800 px-4 py-2 text-sm">
                  Mobile Development
                </Badge>
                <Badge className="bg-gray-900 text-silver hover:bg-gray-800 px-4 py-2 text-sm">UI/UX Design</Badge>
                <Badge className="bg-gray-900 text-silver hover:bg-gray-800 px-4 py-2 text-sm">DevOps</Badge>
                <Badge className="bg-gray-900 text-silver hover:bg-gray-800 px-4 py-2 text-sm">Security</Badge>
                <Badge className="bg-gray-900 text-silver hover:bg-gray-800 px-4 py-2 text-sm">Database</Badge>
                <Badge className="bg-gray-900 text-silver hover:bg-gray-800 px-4 py-2 text-sm">Machine Learning</Badge>
              </div>
            </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-2/3">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button className="bg-silver hover:bg-gray-300 text-black">Subscribe</Button>
                  </div>
                </div>
